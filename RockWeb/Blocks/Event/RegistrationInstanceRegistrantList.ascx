w<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegistrationInstanceRegistrantList.ascx.cs" Inherits="RockWeb.Blocks.Event.RegistrationInstanceRegistrantList" %>
