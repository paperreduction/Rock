...
namespace RockWeb.Blocks.Event
{
    ...
    public partial class RegistrationInstanceFeeList : Rock.Web.UI.RockBlock
    {
        #region Properties
        ...
        protected void gFees_GridRebind( object sender, GridRebindEventArgs e )
        {
            ...
            gFees.ExportTitleName = _RegistrationInstance.Name + " - Registration Fees";
            gFees.ExportFilename = gFees.ExportFilename ?? _RegistrationInstance.Name + "RegistrationFees";
