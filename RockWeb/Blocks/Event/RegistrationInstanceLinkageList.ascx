<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegistrationInstanceLinkageList.ascx.cs" Inherits="RockWeb.Blocks.Event.RegistrationInstanceDiscountList" %>
